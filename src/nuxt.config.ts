...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    gameServerImageName: readRuntimeEnv('GAME_SERVER_IMAGE', 'renegademaster/zomboid-dedicated-server:latest'),
    gameServerMemoryLimit: readRuntimeEnv('GAME_SERVER_MEM_LIMIT', '4g'),
    gameServerMemoryReservation: readRuntimeEnv('GAME_SERVER_MEM_RESERVATION', '3g'),
    gameServerMaxRam: readRuntimeEnv('PZ_MAX_RAM', '3072m'),
